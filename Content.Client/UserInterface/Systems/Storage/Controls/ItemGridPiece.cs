...
public sealed class ItemGridPiece : Control, IEntityControl
{
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
        ...
        if (itemComponent.StoredSprite is { } storageSprite)
        {
            ...
            // Misfit change:  sprite.Height was in wrong param
            var spriteBox = new Box2Rotated(new Box2(0f, 0f, sprite.Width * scale, sprite.Height * scale), -iconRotation, Vector2.Zero);
