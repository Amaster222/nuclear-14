...
/// <summary>
/// Shared implementation used by the server-side body-cavity system.
/// It is abstract so client DI can select its client-only no-op counterpart.
/// </summary>
public abstract class InsideBodyPartSystem : CommonInsideBodyPartSystem
{
